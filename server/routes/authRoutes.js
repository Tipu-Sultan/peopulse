...
const { Signup, getUserDetails, Login, ForgotPassword, ResetPassword, activateAuthUser, deleteAuthAccount, getAllUserDetails, getOtherDetails, editUserDetails } = require("../controller/AuthController");
